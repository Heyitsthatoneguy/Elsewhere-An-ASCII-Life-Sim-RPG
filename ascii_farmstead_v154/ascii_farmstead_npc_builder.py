    ...
    for raw_key, raw_population in value.items():
        ...
        for raw_resident_id, raw_resident in (
            ...
            residents[resident_id] = {
                ...
                "runtime_schedule_location": str(raw_resident.get("runtime_schedule_location", "") or ""),
                "runtime_schedule_target_x": int(raw_resident.get("runtime_schedule_target_x", -1) or -1),
                "runtime_schedule_target_y": int(raw_resident.get("runtime_schedule_target_y", -1) or -1),
                "runtime_transition": str(raw_resident.get("runtime_transition", "") or ""),
                "runtime_transition_target": str(raw_resident.get("runtime_transition_target", "") or ""),
                "runtime_target_x": int(raw_resident.get("runtime_target_x", -1) or -1),
                "runtime_target_y": int(raw_resident.get("runtime_target_y", -1) or -1),
                "runtime_floor": max(0, int(raw_resident.get("runtime_floor", 0) or 0)),
                "runtime_blocked_ticks": max(0, int(raw_resident.get("runtime_blocked_ticks", 0) or 0)),
                "runtime_opened_door_x": int(raw_resident.get("runtime_opened_door_x", -1) or -1),
                "runtime_opened_door_y": int(raw_resident.get("runtime_opened_door_y", -1) or -1),
...
class ProceduralNpcBuilder:
    ...
    def create_resident(
        ...
        resident = {
            ...
            "runtime_y": -1,
            "runtime_location": "",
            "runtime_schedule_location": "",
            "runtime_schedule_target_x": -1,
            "runtime_schedule_target_y": -1,
            "runtime_transition": "",
            "runtime_transition_target": "",
            "runtime_target_x": -1,
            "runtime_target_y": -1,
            "runtime_floor": 0,
            "runtime_blocked_ticks": 0,
            "runtime_opened_door_x": -1,
            "runtime_opened_door_y": -1,
            "runtime_phase": "",
            "runtime_day_key": "",
            "runtime_weather": "",
            "runtime_activity": "",
        ...
        if existing_clean:
            ...
            for resident_id, resident in population["residents"].items():
                ...
                for field in (
                    ...
                    "runtime_location",
                    "runtime_schedule_location",
                    "runtime_schedule_target_x",
                    "runtime_schedule_target_y",
                    "runtime_transition",
                    "runtime_transition_target",
                    "runtime_target_x",
                    "runtime_target_y",
                    "runtime_floor",
                    "runtime_blocked_ticks",
                    "runtime_opened_door_x",
                    "runtime_opened_door_y",
                    "runtime_phase",
                    "runtime_day_key",
                    "runtime_weather",
                    "runtime_activity",
